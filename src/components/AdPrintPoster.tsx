        ...
        <div className="a4-poster" aria-hidden="true">
          <div className="a4-poster__sheet">
            <header className="a4-poster__header">
              <BrandMark size="lg" variant="soft" className="a4-poster__brand" />
              <span className="a4-poster__chip">{TYPE_LABEL[ad.t]}</span>
            </header>

            <div className="a4-poster__title-block">
            ...
            {ad.desc && (
              <p className="a4-poster__desc">{ad.desc.length > 320 ? `${ad.desc.slice(0, 317)}…` : ad.desc}</p>
            )}
